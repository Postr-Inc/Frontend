      ...
      <div
        ...
        className={`
         ...
         top-12
          ...
          ${
            error
              ? `text-error  font-thin rounded 
            ${
              theme === "black"
                ? "text-white bg-[#ff41334b]"
                : "text-black  border border-base-200"
            }
            `
              : `text-sky-500  border-base-200 shadow rounded  ${
                  theme === "black" ? "bg-base-300" : "bg-white"
                }   `
          }
          `}
      >
