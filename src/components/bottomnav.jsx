...
export default function BottomNav() {
    ...
    let theme  = window.matchMedia("(prefers-color-scheme: dark)").matches ? "bg-darker" : "bg-base-200"
    return <div className=" fixed bottom-8 left-[50%] transform -translate-x-1/2 w-64
     ">
    <ul className={`menu menu-horizontal rounded-box p-2 w-fit
    ${
        window.matchMedia("(prefers-color-scheme: dark)").matches ? "bg-darker" : "bg-base-200"
    }
    `}>
  ...
  <li>
    ...
    <svg className="
              ...
              " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"></path></svg>
    </a>
  </li>
  <li>
    <a>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="
              ...
              "><path stroke-linecap="round" stroke-linejoin="round" d="M7.5 3.75H6A2.25 2.25 0 003.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0120.25 6v1.5m0 9V18A2.25 2.25 0 0118 20.25h-1.5m-9 0H6A2.25 2.25 0 013.75 18v-1.5M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
    </a>
  </li>
  <li>
    <a>
