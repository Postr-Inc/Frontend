...
export default function MainPage(props: Props) {
  ...
  return (
    <div
      key={props.key}
      className="relative xl:flex xl:w-[35vw]
         md:w-[50vw]  xl:p-0  lg:flex   2xl:w-[80vw]   justify-center xl:mx-auto    "
    >
      <SideBarLeft {...props} />
      ...
      {poorConnection && !dismissToast ? (
       ...
       {
        props.hideRight ? "" :  <SideBarRight {...props} />
       }
      <LogoutModal {...props} />
       {
       props.hideBottomNav ?   ""  : <div className="xl:hidden lg:hidden">
        <BottomNav {...props} />
      </div>  
       }
    </div>
